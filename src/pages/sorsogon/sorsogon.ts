...
/**
 * Generated class for the SorsogonPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sorsogon',
  templateUrl: 'sorsogon.html',
})
export class SorsogonPage {
 // restaurants
  ...
  constructor(public app: App, public nav: NavController, public gatewayService: GatewayService,
    ...
    // set sample data
    this.restaurants = restaurantService.getItemByPlace("Sorsogon");
    this.hotels = hotelService.getItemByPlace("Sorsogon");
    this.attractions = attractionService.getItemByPlace("Sorsogon");
