...
/**
 * Generated class for the MasbatePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-masbate',
  templateUrl: 'masbate.html',
})
export class MasbatePage {
  ...
  constructor(public app: App, public nav: NavController, public gatewayService: GatewayService,
    ...
    // set sample data
    this.restaurants = restaurantService.getItemByPlace("Masbate");
    this.hotels = hotelService.getItemByPlace("Masbate");
    this.attractions = attractionService.getItemByPlace("Masbate");
