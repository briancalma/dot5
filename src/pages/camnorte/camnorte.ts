...
/**
 * Generated class for the CamnortePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-camnorte',
  templateUrl: 'camnorte.html',
})
export class CamnortePage {
  ...
  constructor(public app: App, public nav: NavController, public gatewayService: GatewayService,
    ...
    // set sample data
    this.restaurants = restaurantService.getItemByPlace("Camarines Norte");
    this.hotels = hotelService.getItemByPlace("Camarines Norte");
    this.attractions = attractionService.getItemByPlace("Camarines Norte");
