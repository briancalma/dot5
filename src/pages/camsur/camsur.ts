...
/**
 * Generated class for the CamsurPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-camsur',
  templateUrl: 'camsur.html',
})
export class CamsurPage {
  ...
  constructor(public app: App, public nav: NavController, public gatewayService: GatewayService,
    ...
    // set sample data
    this.restaurants = restaurantService.getItemByPlace("Camarines Sur");
    this.hotels = hotelService.getItemByPlace("Camarines Sur");
    this.attractions = attractionService.getItemByPlace("Camarines Sur");
